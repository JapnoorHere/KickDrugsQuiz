      ...
      {loading ? (
        ...
        (
            ...
            questions.message === 'notFound' ?
              (<div className='overflow-hidden bg-tan-light min-h-screen w-screen flex justify-center items-center p-4'>
                <div className='border border-tan-dark flex flex-col gap-4 bg-tan-medium w-[600px] p-6 rounded-lg shadow-lg'>
                ...
                <div className='overflow-hidden bg-tan-light min-h-screen w-screen flex justify-center items-center p-4'>
                  ...
                  <form
                    action=""
                    className='border border-tan-dark flex flex-col gap-4 bg-tan-medium w-[600px] p-6 rounded-lg shadow-lg' onSubmit={submitData}>
                    <h1 className='text-brown-dark text-4xl font-medium'>Quiz</h1>
